...
% GROWOutputStruct = extractGROWoutput(GROWInputParameters.growFileName, crackLocations);
...
function [inputParameters, GROWInputParameters] = userInput()
    ...
    fault_flaw.T            = 1;            % Tensional strenght
...
outputFileName = [growFileName,'.out'];
...
blocksPerCrack = 1; % make sure this is correct
expectedFric2dDataBlocks = 4; % this is here to make sure that I'm not fucking up the parsing of the output
